                ...
                if news:
                    for article in news:
                        try:
                            ...
                            logger.info(f"Processing {symbol} - {publish_date} UTC")
    ...
    def collect_and_train(self, symbols):
        ...
        if training_data:
            ...
            for sample in training_data[:3]:
                ...
                logger.info(f"News Text: {sample['text'][:200]}...")
                logger.info(f"Price Changes: {sample['changes']}")
            ...
            for timeframe in ['1h', '1wk', '1mo']:
                ...
                # Handle NaN values
                y = [sample['changes'].get(timeframe, 0) for sample in training_data]
